package com.logicauth.tracker.security;
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            System.out.println("DEBUG: Checking JWT Token: " + (jwt != null ? "Token Found" : "Token NULL"));
            ...
            System.err.println("DEBUG ERROR: Cannot set user authentication: " + e.getMessage());
        }
